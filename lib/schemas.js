...
var TransactionsSchema = function () {
  ...
  _createClass(TransactionsSchema, [{
    ...
    value: function define(schemasByKey) {
      ...
      var indexedItemKeys = items.filter(function (_ref) {
        var isIndex = _ref.isIndex;
        return isIndex;
      }).map(function (_ref2) {
        var key = _ref2.key;
        return key;
      });
      indexedItemKeys.forEach(function (indexedItemKey) {
        return !_this.model.indexedItemKeys.includes(indexedItemKey) && _this.model.indexedItemKeys.push(indexedItemKey);
      });
